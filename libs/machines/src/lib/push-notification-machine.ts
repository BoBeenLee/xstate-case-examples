...
createMachine(
  ...
  states: {
    ...
    subscription: {
      ...
      exit: 'setPusnNotificationUnsubscription',
    },
  },
}, {
  guards: {
  ...
  actions: {
    ...
    setPusnNotificationUnsubscription: (context, event) => {
      console.log('setPusnNotificationUnsubscription');
    },
  }
});
